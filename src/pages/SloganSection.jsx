...
export const SloganSection = () => {
  ...
  return (
    <div className="sloganSection bg-white text-black p-12 text-center">
      ...
      <div className="rotateText pt-10">
        <h1 className="text-[38vw] font-[anzo5] leading-[30vw]">IMPACTFULL</h1>
      </div>
      <div className="rotateText">
        <h1 className="text-[38vw] font-[anzo5] leading-[30vw]">DESIGN</h1>
      </div>
      <div className="rotateText">
        <h1 className="text-[38vw] font-[anzo5] leading-[30vw]">IS THE</h1>
      </div>
      <div className="rotateText">
        <h1 className="text-[38vw] font-[anzo5] leading-[30vw]">DESIGN</h1>
      </div>
      <div className="rotateText">
        <h1 className="text-[38vw] font-[anzo5] leading-[30vw]">THAT</h1>
      </div>
      <div className="rotateText">
        <h1 className="text-[38vw] font-[anzo5] leading-[30vw]">WORKS!</h1>
      </div>
      <div className="flex items-center justify-center scale-[0.60]">
        <svg
